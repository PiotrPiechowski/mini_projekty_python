...
def welcome():
    entry = int(input("""Welcome to Python Contact Book.
                    >>>Python Contact Book commands are: 1,2,3 or 4 <<<
...
def phonebook():
    ...
    while True:
        ...
        if entry == 1:
            ...
            contact_name = input('What would you like to save the name as? Enter in the form "FirstName,LastName".: ')
            ...
            if phone_number not in contact.items():
                ...
                print('That contact alredy exits in your Phonebook')

        elif entry == 3:
            name = input('Enter the name of the contact detail you wish to view: ')
            
            if name in contact:
                print('The contact is',name,':',contact[name])
            
            else: 
                print('That contactdoes not exist! Return to the main menu to enter the contact')

        elif entry == 4:
            name = input('Enter the name of the contact you wish to delete: ')

            if name in contact:
                print('That contact is',name,':', contact[name])
            else:
            ...
            print('Thanks for using Python Contact Book')
            break

        else: 
            print('Inncorent Entry!')
