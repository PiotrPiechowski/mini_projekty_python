...
if password_length < 5:
    print("Hasło musi zawierać minimum 5 znaków, spróbuj jeszcze raz.")
    sys.exit(0)
else:
...
if uppercase_letters < 0 or lowercase_letters > characters_left:
    print("Liczba znaków spoza przedziału 0,", characters_left)
    sys.exit(0)
...
if characters_left >0:
    print("Uzupełnij reszte hasła małymi literami")
